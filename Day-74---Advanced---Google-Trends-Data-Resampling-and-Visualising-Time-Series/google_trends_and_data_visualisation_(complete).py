# -*- coding: utf-8 -*-
"""Google Trends and Data Visualisation (COMPLETE).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1M14_nTy-zvjg3JF3Ljhzo2UVBwttlqAE
...
ax1 = plt.gca()
ax2 = ax1.twinx()
ax1.set_ylabel('TESLA Stock Price',color='#e0694f')
ax2.set_ylabel('Search Trend',color='skyblue')
ax1.plot(df_tesla.MONTH,df_tesla.TSLA_USD_CLOSE,color='#e0694f')
...
ax1.plot(df_btc_monthly.index, df_btc_monthly.CLOSE,linewidth=3 ,color='#F08F2E',linestyle='dashed')
...
ax1.plot(df_unemployment.MONTH, df_unemployment.UNRATE ,linewidth=3 ,color='#F08F2E',linestyle='dashed')
...
ax1.plot(df_unemployment.MONTH, roll_df.UNRATE ,linewidth=3 ,color='#F08F2E',linestyle='dashed')
